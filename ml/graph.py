...
# G = Graph()
# G.add_edge(start_node_id="A", end_node_id="B", weight=1)
# G.add_edge(start_node_id="A", end_node_id="F", weight=4)
# G.add_edge(start_node_id="A", end_node_id="E", weight=4)
# G.add_edge(start_node_id="B", end_node_id="C", weight=4)
# G.add_edge(start_node_id="B", end_node_id="D", weight=4)
# G.add_edge(start_node_id="B", end_node_id="F", weight=4)
# # G.add_edge(start_node_id="A", end_node_id="C", weight=2)
# # G.add_edge(start_node_id="A", end_node_id="D", weight=3)
#
# # G.add_edge(start_node_id="C", end_node_id="F", weight=4)
# # G.delete_edge(start_node_id="A", end_node_id="B")
#
# traversal = G.graph_traversal(start_id="A", abs_level=10)
# for t in traversal:
#     print(t, traversal[t])